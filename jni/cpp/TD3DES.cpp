...
/*
    * 有自定义密码的3DES 加密
   */
 std::string  TD3DES::encryptDES(const std::string& data , std::string k, int *lenreturn){
  ...
  //  memset((void *)(k.c_str() + key_len), 0x00, LEN_OF_KEY - key_len);
    ...
    *lenreturn = len;
    ...
    if (NULL != dst) {
       ...
       std::string eresult((char*)dst, (unsigned int) len);
//        std::string eresult;
//        eresult.clear();
...
//                (char *) dst);
 ...
 std::string    TD3DES::decryptDES(const std::string& data,  std::string  k, int data_len){
    ...
    if (NULL != dst) {
        static std::string dresult((char*)dst, (unsigned int) len);
//        dresult.clear();//
 ...
 */
  std::string   TD3DES::encryptDES(const std::string& data , int *lenreturn){
...
#define LEN_OF_KEY 24
  ...
  std::string   TD3DES::decryptDES(const std::string& data , int data_len){
