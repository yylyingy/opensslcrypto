...
std::string TDBASE64::base64_encodestring(const std::string &text ){
    EVP_ENCODE_CTX ectx;
...
std::string TDBASE64::base64_decodestring(const std::string &text ){
    EVP_ENCODE_CTX ectx;
...
std::string TDBASE64::base64_decode(const std::string& encoded_bytes, int *decoded_length) {
    BIO *bioMem, *b64;
...
/* Return NULL if failed, REMEMBER to free() */
 std::string TDBASE64::base64_encode(const std::string& decoded_bytes,
